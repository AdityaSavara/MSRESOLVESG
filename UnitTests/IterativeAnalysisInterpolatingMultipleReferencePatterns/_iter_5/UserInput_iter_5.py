referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_4.csv', 'AcetaldehydeNISTRefMixed2Edit_unused_iter_4.csv']
referencePatternsFormsList = ['xyyy', 'xyyy']
dataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_4.csv'
referencePatternTimeRanges = [[176, 200], [250, 400]]
ionizationDataFileName = '_ProvidedIonizationData.csv'
iterativeAnalysis = True
iterationNumber = 4
iterationSuffix = '_iter_4'
unusedMolecules = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'H2']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_3.csv', 'AcetaldehydeNISTRefMixed2Edit_unused_iter_3.csv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_3.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_4.csv', 'AcetaldehydeNISTRefMixed2Edit_unused_iter_4.csv']
nextExpFileName = '2-CrotAcetExp#2Truncated_remaining_iter_4.csv'
preProcessing = 'yes'
dataAnalysis = 'yes'
dataSimulation = 'yes'
grapher = 'no'
...
chosenMoleculesNames = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'H2']
...
checkpoint = 10.5364646
start = 10.0825263
timeSinceLastCheckpoint = 0.32286080000000084
iterationNumber = 4

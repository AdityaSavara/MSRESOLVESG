referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_2.csv', 'AcetaldehydeNISTRefMixed2Edit_unused_iter_2.csv']
referencePatternsFormsList = ['xyyy', 'xyyy']
dataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_2.csv'
referencePatternTimeRanges = [[176, 200], [250, 400]]
ionizationDataFileName = '_ProvidedIonizationData.csv'
iterativeAnalysis = True
iterationNumber = 2
iterationSuffix = '_iter_2'
unusedMolecules = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'H2', 'H2O']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_1.csv', 'AcetaldehydeNISTRefMixed2Edit_unused_iter_1.csv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_1.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_2.csv', 'AcetaldehydeNISTRefMixed2Edit_unused_iter_2.csv']
nextExpFileName = '2-CrotAcetExp#2Truncated_remaining_iter_2.csv'
preProcessing = 'yes'
dataAnalysis = 'yes'
dataSimulation = 'yes'
grapher = 'no'
...
chosenMoleculesNames = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'H2', 'H2O']
...
checkpoint = 9.1944781
start = 8.6944122
timeSinceLastCheckpoint = 0.3091502999999989
iterationNumber = 2
...
chosenMoleculesNames = ['Ethanol']
chosenMassFragments = [31]

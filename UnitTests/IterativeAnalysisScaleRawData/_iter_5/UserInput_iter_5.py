referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_4.csv']
...
unusedMolecules = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_3.csv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_3.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_4.csv']
...
chosenMoleculesNames = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol']
...
checkpoint = 12.4373893
start = 11.822492
timeSinceLastCheckpoint = 0.45390139999999946
iterationNumber = 4

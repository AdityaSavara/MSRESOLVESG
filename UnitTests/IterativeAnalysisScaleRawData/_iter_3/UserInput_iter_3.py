referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_2.csv']
...
unusedMolecules = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'H2']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_1.csv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_1.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_2.csv']
...
chosenMoleculesNames = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'H2']
...
checkpoint = 10.456997
start = 9.6648847
timeSinceLastCheckpoint = 0.5812955000000013
iterationNumber = 2
...
chosenMoleculesNames = ['H2']
chosenMassFragments = [2]

...
UserChoices['uncertainties']['dataToAnalyze_uncertainties'] = None # or 'File' or 'None'. Will expect same file name as collected file with _uncertainties after that).

...
#Expected output:
expected_output1 = np.genfromtxt("ScaledConcentrationsExpected_test_2.csv", skip_header = 1, delimiter =",")
expected_output2 = np.genfromtxt("ScaledConcentrations_relative_uncertainties_test_2.csv", skip_header = 1, delimiter =",")

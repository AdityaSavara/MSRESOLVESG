...
UserChoices['tuningCorrection']['referenceFileExistingTuningAndForm'] = [] #['ReferenceExternal.csv', 'xyxy']
UserChoices['tuningCorrection']['referenceFileDesiredTuningAndForm'] = []

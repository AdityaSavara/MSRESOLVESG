...
UserChoices['tuningCorrection']['referenceFileDesiredTuningAndForm'] ='AcetaldehydeOnlyNISTRef.csv' #this will be ignored in test_15.py
...
UserChoices['tuningCorrection']['referenceCorrectionCoefficients_cov'] = [0,0,0] #no cov.

referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_2.tsv']
...
unusedMolecules = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2', 'H2O']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_1.tsv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_1.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_2.tsv']
...
chosenMoleculesNames = ['Acetaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2', 'H2O']
...
checkpoint = 8.9717556
start = 8.4318452
timeSinceLastCheckpoint = 0.3833114000000002
iterationNumber = 2

referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_3.tsv']
referencePatternsFormsList = ['xyyy']
dataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_3.csv'
...
unusedMolecules = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Crotyl Alcohol', 'H2', 'H2O']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_2.tsv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_2.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_3.tsv']
...
chosenMoleculesNames = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Crotyl Alcohol', 'H2', 'H2O']
...
checkpoint = 9.7163717
start = 9.1740151
timeSinceLastCheckpoint = 0.37218279999999915
iterationNumber = 3

referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_5.tsv']
...
unusedMolecules = ['(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2', 'H2O']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_4.tsv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_4.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_5.tsv']
...
chosenMoleculesNames = ['(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2', 'H2O']
...
checkpoint = 11.1371736
start = 10.5897867
timeSinceLastCheckpoint = 0.40611840000000043
iterationNumber = 5

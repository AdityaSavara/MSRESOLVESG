referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_4.tsv']
...
unusedMolecules = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_3.tsv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_3.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_4.tsv']
...
chosenMoleculesNames = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'CO', 'CO2', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2']
...
checkpoint = 10.3944501
start = 9.9081885
timeSinceLastCheckpoint = 0.3445577000000011
iterationNumber = 4

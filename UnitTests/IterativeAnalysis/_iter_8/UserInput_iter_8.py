referencePatternsFileNamesList = ['AcetaldehydeNISTRefMixed2_unused_iter_7.tsv']
referencePatternsFormsList = ['xyyy']
dataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_7.csv'
...
unusedMolecules = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2O']
oldReferenceFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_6.tsv']
oldDataToAnalyzeFileName = '2-CrotAcetExp#2Truncated_remaining_iter_6.csv'
nextRefFileName = ['AcetaldehydeNISTRefMixed2_unused_iter_7.tsv']
...
chosenMoleculesNames = ['Acetaldehyde', '(E) 2-Butenal (Crotonaldehyde', 'Ethylene (Ethene)', 'Ethanol', 'Crotyl Alcohol', 'H2O']
...
checkpoint = 12.8785381
start = 12.0212018
timeSinceLastCheckpoint = 0.7510291000000002
iterationNumber = 7

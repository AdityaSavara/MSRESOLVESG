...
UserChoices['inputFiles']['referencePatternsFileNamesList'] = ['AcetaldehydeNISTRefMixed2XYYY.csv'] #enter the file name of the file containing reference information

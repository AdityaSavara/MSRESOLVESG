...
# Package meta-data.
NAME = 'MSRESOLVESG'
DESCRIPTION = 'This is the MSRESOLVESG package for mass spectrometry data analysis https://github.com/AdityaSavara/MSRESOLVESG for more information.'
URL = 'https://github.com/AdityaSavara/MSRESOLVESG'
